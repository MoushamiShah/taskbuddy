...
// Filter for completed enquiries
$status_filter = 'Complete';

// Fetch completed enquiries securely
$sql = "SELECT * FROM enquiry_list WHERE status = ? ORDER BY created_at DESC";
